...
export const categories = [
  ...
  { 
    ...
    name: 'Gift Packing', 
    icon: '📦', 
    description: 'Professional gift wrapping services' 
  },
  { 
    id: 'calligraphy', 
    name: 'Calligraphy', 
    icon: '✍️', 
    description: 'Custom calligraphy and artwork' 
  },
  { 
    id: 'birthday-gifts', 
    name: 'Birthday Gifts', 
    icon: '🎂', 
    description: 'Special birthday celebration items' 
  },
  { 
    id: 'couple-gifts', 
    name: 'Couple Gifts', 
...
// High-quality, working image URLs
const imageUrls = {
  flowers: [
  ...
  calligraphy: [
    'https://images.pexels.com/photos/159519/back-to-school-paper-colored-paper-stationery-159519.jpeg?auto=compress&cs=tinysrgb&w=800',
    'https://images.pexels.com/photos/261763/pexels-photo-261763.jpeg?auto=compress&cs=tinysrgb&w=800',
    'https://images.pexels.com/photos/301703/pexels-photo-301703.jpeg?auto=compress&cs=tinysrgb&w=800',
    'https://images.pexels.com/photos/207665/pexels-photo-207665.jpeg?auto=compress&cs=tinysrgb&w=800'
  ],
  couples: [
...
export const mockProducts: Product[] = [
  {
    ...
    price: 2500,
    image: imageUrls.flowers[0],
    images: imageUrls.flowers.slice(0, 3),
    isFeatured: true,
    tags: ['roses', 'bouquet', 'romantic', 'wedding'],
    inventory: { total: 50, remaining: 35, lowStockThreshold: 10 },
    rating: { average: 4.8, count: 24 },
    specifications: { material: 'Premium Silk', dimensions: '30cm x 25cm', color: 'Red & Pink' }
  },
  {
    id: '2',
    ...
    price: 3500,
    image: imageUrls.gifts[0],
    images: imageUrls.gifts.slice(0, 2),
    isFeatured: true,
    tags: ['gift', 'luxury', 'premium', 'box'],
    inventory: { total: 30, remaining: 8, lowStockThreshold: 5 },
    rating: { average: 4.9, count: 18 },
    specifications: { material: 'Cardboard & Silk', dimensions: '25cm x 20cm x 10cm', color: 'Gold & White' }
  },
  {
    id: '3',
    ...
    price: 1500,
    image: imageUrls.calligraphy[0],
    images: imageUrls.calligraphy.slice(0, 3),
    tags: ['calligraphy', 'custom', 'art', 'personalized'],
    inventory: { total: 25, remaining: 20, lowStockThreshold: 5 },
    rating: { average: 4.7, count: 12 },
    specifications: { material: 'Premium Paper', dimensions: 'A4 (21cm x 29.7cm)', color: 'Black Ink' }
  },
  {
    id: '4',
    ...
    price: 4000,
    image: imageUrls.gifts[2],
    images: [imageUrls.gifts[2], imageUrls.gifts[1]],
    isFeatured: true,
    tags: ['birthday', 'celebration', 'party', 'decorations'],
    inventory: { total: 40, remaining: 25, lowStockThreshold: 8 },
    rating: { average: 4.6, count: 31 },
    specifications: { material: 'Mixed Materials', dimensions: 'Package Set', color: 'Multicolor' }
  },
  {
    id: '5',
    ...
    price: 2800,
    image: imageUrls.couples[0],
    images: imageUrls.couples,
    tags: ['couple', 'memory', 'book', 'romantic'],
    inventory: { total: 20, remaining: 15, lowStockThreshold: 5 },
    rating: { average: 4.9, count: 15 },
    specifications: { material: 'Leather & Paper', dimensions: '20cm x 25cm', color: 'Brown Leather' }
  },
  {
    id: '6',
    ...
    price: 500,
    image: imageUrls.gifts[1],
    images: [imageUrls.gifts[1], imageUrls.gifts[0]],
    tags: ['wrapping', 'service', 'luxury', 'presentation'],
    inventory: { total: 100, remaining: 85, lowStockThreshold: 20 },
    rating: { average: 4.5, count: 42 },
    specifications: { material: 'Premium Wrapping Paper', dimensions: 'Custom Size', color: 'Various Options' }
  },
  {
    id: '7',
    ...
    price: 2200,
    image: imageUrls.flowers[1],
    images: [imageUrls.flowers[1], imageUrls.flowers[2]],
    isUpcoming: true,
    tags: ['sakura', 'spring', 'japanese', 'delicate'],
    inventory: { total: 15, remaining: 15, lowStockThreshold: 3 },
    rating: { average: 0, count: 0 },
    specifications: { material: 'Silk & Wire', dimensions: '35cm x 30cm', color: 'Pink & White' }
  },
  {
    id: '8',
    ...
    price: 3800,
    image: imageUrls.couples[1],
    images: imageUrls.couples,
    isUpcoming: true,
    tags: ['anniversary', 'special', 'romantic', 'personalized'],
    inventory: { total: 12, remaining: 12, lowStockThreshold: 3 },
    rating: { average: 0, count: 0 },
    specifications: { material: 'Wood & Fabric', dimensions: '30cm x 25cm x 15cm', color: 'Natural Wood' }
  },
  // Additional calligraphy products
  {
    id: '9',
    ...
    price: 2500,
    image: imageUrls.calligraphy[1],
    images: [imageUrls.calligraphy[1], imageUrls.calligraphy[0]],
    tags: ['wedding', 'invitation', 'elegant', 'custom'],
    inventory: { total: 20, remaining: 15, lowStockThreshold: 5 },
    rating: { average: 4.9, count: 8 },
    specifications: { material: 'Premium Cardstock', dimensions: '15cm x 21cm', color: 'Gold Ink' }
  },
  {
    id: '10',
    ...
    price: 1800,
    image: imageUrls.calligraphy[2],
    images: [imageUrls.calligraphy[2], imageUrls.calligraphy[1]],
    tags: ['inspirational', 'quote', 'modern', 'motivational'],
    inventory: { total: 30, remaining: 25, lowStockThreshold: 8 },
    rating: { average: 4.5, count: 15 },
    specifications: { material: 'Canvas Paper', dimensions: 'A3 (29.7cm x 42cm)', color: 'Black & Gold' }
  },
  {
    id: '11',
    ...
    price: 2200,
    image: imageUrls.calligraphy[3],
    images: [imageUrls.calligraphy[3], imageUrls.calligraphy[0]],
    tags: ['arabic', 'islamic', 'traditional', 'religious'],
    inventory: { total: 15, remaining: 12, lowStockThreshold: 3 },
    rating: { average: 4.8, count: 10 },
    specifications: { material: 'Handmade Paper', dimensions: 'A2 (42cm x 59.4cm)', color: 'Traditional Black' }
  },
  {
    id: '12',
    ...
    price: 2000,
    image: imageUrls.flowers[3],
    images: [imageUrls.flowers[3], imageUrls.flowers[0]],
    tags: ['sunflower', 'bright', 'cheerful', 'arrangement'],
    inventory: { total: 30, remaining: 22, lowStockThreshold: 8 },
...
export const addProduct = (product: Omit<Product, 'id'>): Product => {
  ...
  const newProduct = { 
    ...
    inventory: product.inventory || { total: 0, remaining: 0, lowStockThreshold: 5 },
